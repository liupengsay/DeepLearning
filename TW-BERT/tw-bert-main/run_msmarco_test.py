...
if __name__ == "__main__":
	...
	qrels_dev = pl.read_csv("D:\\DeepLearning\\TW-BERT\\qrels.dev.tsv", separator='\t', has_header=False,new_columns=["qid", "i", "pid", "label"])
	top1000 = pl.read_csv("D:\\迅雷下载\\top1000.dev\\top1000.dev", separator='\t', has_header=False, new_columns=["qid", "pid", "query", "passage"])
